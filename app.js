...
async function testGitHubTokenConnection() {
    ...
    // Fixed: Lift targetApiResponse scope definition out of try/catch to make it accessible in finally block
    ...
    try {
        ...
        // Fixed: Safely check both the existence of testBtn and targetApiResponse
...
function initDraftAutosave() {
    ...
    const triggerSave = () => {
        ...
        const draftPayload = {
            ...
            editingId: AppState.editingId, // Retain target session metadata
            timestamp: Date.now()
        };
    ...
    // Attach high-performance input monitors
...
function checkAndShowDraftBanner() {
    ...
    // Clear preexisting instances to prevent UI stacking
...
// Expose Recovery Actions to Global Window context
